#!/bin/bash
#
# this sets P13-1  on CTI Spacely carrier , and turns P13-1/ sysfs 486 / GPIO 14 to 'on' state
...
i2cset -y -f 0x00 0x77 0x03 0xff  #set output register all on for P13-1 to P13-8
